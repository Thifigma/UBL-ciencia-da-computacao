...
\begin{document}
	...
	O Circuito a ser observado pode ser encontrado na pasta 
	circuitos/combinacionais/circuito-F.dig. 
	É construido pela função F(A, B, C, D) e de saida (E). 
	Vamos obter a expressão algébrica deste circuito. \\
	\newline
	...
	$ \\	
	\newline
	O próximo circuito pode ser encontrado na seguinte pasta, 
	circuitos/combinacionais/somador-completo.dig. \\
	\newline
	Repare que neste caso existem duas saidas
	...
	não interfere na lógica da arquitetura, ou seja, é apenas uma 
	...
	$D = (A \oplus B \oplus C)$ \\
	\newline
	Neste ponto, fica fácil observar que podemos usar os metodos de 
	simplificações algébricas booleanas para diminuir os circuitos digitais, 
	e isso é fantastico.
