...
\begin{document}
	...
	Todos os circuitos estão disponíveis, na pasta \texttt{circuitos} e 
	possuem a extensão .dig e só podem ser visualizados com o simulador
	disponível na pagina inicial do projeto.


	\subsection{\centering Portas Universais}

	As portas lógicas NAND e NOR são ditas portas lógicas universais, pois
	com apenas umas dessas portas podemos representar todas as outras

	Observe as construções das portas NOT, AND e OR com a porta NAND
	dentro do diretorio universais.
