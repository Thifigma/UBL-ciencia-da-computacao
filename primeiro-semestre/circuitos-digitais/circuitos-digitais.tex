...
\begin{document}
	...
	álgebrica. Observe o exemplo abaixo: \\
	\begin{table}[ht]
                \centering
                \begin{tabular}{|c|c|c|c|}
                        \hline
	...
	\newline
	Para útilizarmos os \texttt{Maxtermos} devemos deixar o zero intacto e alterar 
	...
	Agora como queremos a expressão completa devemos então devemos ter 
	o \textbf{produto de cada MAXTERMO}, ou seja \\
	\begin{center} 
		$ %FNC - Produto de soma
		(A \lor B \lor C) \land 
	...
	Faremos agora o \textbf{MINTERMO} para compararmos as formas diferentes
	de se obter uma expressão de uma tabela verdade, observe que neste caso
	devemos manter intacto o valor 1 e negar o valor 0 e devemos fazer isso
	em todas as saidas 1. \\
        \begin{table}[ht]
                \centering
                \begin{tabular}{|c|c|c|c|}
                        \hline
	...
	Pode haver certas confusões com a Forma Normal Conjuntiva e Disjuntiva, 
	e vou exemplificar melhor por partes. \\
	\newline
	\textbf{FND} - Está associada a Mintermos, ou seja, expressões com saidas 1.
	...
	\begin{center}
		$(v * v * v) + (v * v * v) + ... $
	\end{center}
	\textbf{FNC} - Está associada a Maxtermos, ou seja, expressões com saidas 0.
